...
<div class="d-flex flex-md-row flex-column justify-content-center col-md-12">
    <div class="d-flex flex-column justify-content-center text-center col-md-6 mt-5">
        <h2 class="courses">Offre pack entreprise</h2>
        <fieldset>
            <legend><h3>Offrez un moment privilégié à vos salariés</h3></legend>
                <ul class="list-unstyled hl-2">
                    ...
                    <li>- Inscriptions incluses dans le pack (jusqu'à 20 dossards).</li>
