...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Semi Marathon de la Rochelle - Evenenment sportif Charente Maritime">
        ...
        <title>Semi Marathon La Rochelle</title>
    </head>
<header class="navbar" >
            ...
            <div class="container-fluid ">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav link-offset-3">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="medias.php">Médias</a>
                  </li>
                  <li class="nav-item">
